...
## if running NBDA with the spatial network from the locations of individuals in the thermal video, comment the next line and run the following line instead. If not, run the following line, and not the one after it
